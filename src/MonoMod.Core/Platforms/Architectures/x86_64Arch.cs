...
namespace MonoMod.Core.Platforms.Architectures {
    internal class x86_64Arch : IArchitecture {
        ...
        private abstract class DetourKindBase : INativeDetourKind {
            ...
            public abstract int GetBytes(IntPtr from, IntPtr to, Span<byte> buffer, object? data);
        }
        ...
        private sealed class Rel32Kind : DetourKindBase {
            ...
            public override int GetBytes(IntPtr from, IntPtr to, Span<byte> buffer, object? data) {
                buffer[0] = 0xe9;
        ...
        public int GetDetourBytes(NativeDetourInfo info, Span<byte> buffer) {
            ...
            return kind.GetBytes(info.From, info.To, buffer, info.InternalData);
        }
    }
}
