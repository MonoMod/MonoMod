...
namespace MonoMod.Core.Utils
{
    ...
    internal struct StringParser
    {
        ...
        {
            _buffer = Helpers.ThrowIfNull(buffer);
        ...
        public unsafe int ParseNextInt32()
        {
            ...
            fixed (char* bufferPtr = _buffer.AsSpan())
            {
            ...
            Debug.Assert(result == int.Parse(ExtractCurrent(), CultureInfo.InvariantCulture), "Expected manually parsed result to match Parse result");
            return result;
        }
        ...
        public unsafe long ParseNextInt64()
        {
            ...
            Debug.Assert(result == long.Parse(ExtractCurrent(), CultureInfo.InvariantCulture), "Expected manually parsed result to match Parse result");
            return result;
        }
        ...
        public unsafe uint ParseNextUInt32()
        {
            ...
            Debug.Assert(result == uint.Parse(ExtractCurrent(), CultureInfo.InvariantCulture), "Expected manually parsed result to match Parse result");
            return result;
        }
        ...
        public unsafe ulong ParseNextUInt64()
        {
            ...
            Debug.Assert(result == ulong.Parse(ExtractCurrent(), CultureInfo.InvariantCulture), "Expected manually parsed result to match Parse result");
            return result;
        }
