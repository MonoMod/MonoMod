...
namespace MonoMod.UnitTest {
    public class ModInteropTest {
        ...
        public static class UtilsC {
            ...
            public static readonly Func<int, int, int> Something;

            // More complicated use case: Get AnotherThing, apply it on a field of another name.
            [ModImportName("AnotherThing")]
            public static readonly Func<int, int, int> AnotherThingFromAnywhere;
            ...
            public static readonly Func<int, int, int> AnotherThingFromModB;
        ...
        public static class UtilsD {
            public static readonly Func<int, int, int> Something;
            public static readonly Func<int, int, int> AnotherThing;
        }
